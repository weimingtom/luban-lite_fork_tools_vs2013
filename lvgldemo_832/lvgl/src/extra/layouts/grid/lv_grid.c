...
static void calc_cols(lv_obj_t * cont, _lv_grid_calc_t * c)
{
    ...
    c->x = (lv_coord_t *)lv_mem_buf_get(sizeof(lv_coord_t) * c->col_num);
	c->w = (lv_coord_t *)lv_mem_buf_get(sizeof(lv_coord_t)* c->col_num);
...
static void calc_rows(lv_obj_t * cont, _lv_grid_calc_t * c)
{
	...
	c->y = (lv_coord_t *)lv_mem_buf_get(sizeof(lv_coord_t)* c->row_num);
	c->h = (lv_coord_t *)lv_mem_buf_get(sizeof(lv_coord_t)* c->row_num);
    /*Set sizes for CONTENT cells*/
