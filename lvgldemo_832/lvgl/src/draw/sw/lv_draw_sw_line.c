                                                ...
                                                const lv_point_t * point1, const lv_point_t * point2)
{
    ...
    /*If there other mask apply it*/
		...
		lv_opa_t * mask_buf = (lv_opa_t *)lv_mem_buf_get(blend_area_w);
                                                ...
                                                const lv_point_t * point1, const lv_point_t * point2)
{
    ...
    /*If there other mask apply it*/
		...
		lv_opa_t * mask_buf = (lv_opa_t *)lv_mem_buf_get(draw_area_w);
        blend_dsc.mask_buf = mask_buf;
        blend_dsc.mask_area = &blend_area;
                                                 ...
                                                 const lv_point_t * point1, const lv_point_t * point2)
{
	...
	lv_opa_t * mask_buf = (lv_opa_t *)lv_mem_buf_get(mask_buf_size);
