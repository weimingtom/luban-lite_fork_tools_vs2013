...
void lv_obj_set_parent(lv_obj_t * obj, lv_obj_t * parent)
{
    ...
    if(old_parent->spec_attr->child_cnt) {
		old_parent->spec_attr->children = (_lv_obj_t **)lv_mem_realloc(old_parent->spec_attr->children,
...
lv_disp_t * lv_obj_get_disp(const lv_obj_t * obj)
{
    ...
    lv_disp_t * d;
    _LV_LL_READ(&LV_GC_ROOT(_lv_disp_ll), d, lv_disp_t *) {
        uint32_t i;
...
static void obj_del_core(lv_obj_t * obj)
{
    ...
    if(obj->parent == NULL) {
        ...
        disp->screen_cnt--;
		disp->screens = (_lv_obj_t **)lv_mem_realloc(disp->screens, disp->screen_cnt * sizeof(lv_obj_t *));
    }
    /*Remove the object from the child list of its parent*/
		...
		obj->parent->spec_attr->children = (_lv_obj_t **)lv_mem_realloc(obj->parent->spec_attr->children,
