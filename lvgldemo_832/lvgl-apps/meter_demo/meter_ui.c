...
#define HAVE_LVGL_PATH 0

#if HAVE_LVGL_PATH
#include <unistd.h>
#else
#include <stdio.h>
#define ui_snprintf(fmt, arg, ...) _snprintf(fmt, 127, ##arg, __VA_ARGS__)
#define fbdev_draw_fps() (10)
#endif
#include <time.h>
#include <stdio.h>
#include <stdlib.h>
...
#else
	lv_obj_set_style_text_color(bg_fps, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
#endif
